...
var s2_20180520T103019 = ee.Image('COPERNICUS/S2/20180520T103019_20180520T103458_T32UME');
var s2_20180806T104021 = ee.Image('COPERNICUS/S2/20180806T104021_20180806T104340_T32UME');
var s2_20200529T102559 = ee.Image('COPERNICUS/S2/20200529T102559_20200529T103145_T32UME');
var s2_20200601T103629 = ee.Image('COPERNICUS/S2/20200601T103629_20200601T104439_T32UME');
var s2_20201108T104249 = ee.Image('COPERNICUS/S2/20201108T104249_20201108T104243_T32UME');
var s2_20210305T102809 = ee.Image('COPERNICUS/S2/20210305T102809_20210305T103123_T32UME');
var s2_20220325T102651 = ee.Image('COPERNICUS/S2/20220325T102651_20220325T103203_T32UME');
...
Export.image.toDrive({  image: s2_20220325T102651.select("B4", "B3", "B2"),
  description: 's2_20220325T102651',  scale: 10,  region: geometry});    


Export.image.toDrive({  image: s2_20210305T102809.select("B4", "B3", "B2"),
  description: 's2_20210305T102809',  scale: 10,  region: geometry});    

Export.image.toDrive({  image: s2_20201108T104249.select("B4", "B3", "B2"),
  description: 's2_20201108T104249',  scale: 10,  region: geometry});    


Export.image.toDrive({  image: s2_20200601T103629.select("B4", "B3", "B2"),
  description: 's2_20200601T103629',  scale: 10,
  region: geometry});    

Export.image.toDrive({  image: s2_20200529T102559.select("B4", "B3", "B2"),
  description: 's2_20200529T102559',  scale: 10,  region: geometry});    
  
Export.image.toDrive({  image: s2_20180806T104021.select("B4", "B3", "B2"),
  description: 's2_20180806T104021',  scale: 10,  region: geometry});    

Export.image.toDrive({  image: s2_20180520T103019.select("B4", "B3", "B2"),
  description: 's2_20180520T103019',  scale: 10,  region: geometry});    
