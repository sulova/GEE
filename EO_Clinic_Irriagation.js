Export.table.toAsset({
  ...
  description: 'AOI_Irrigation_mask', 
  assetId: 'projects/geo4gras/assets/EO-Clinic/'
});
...
var start = ee.Date('2020-11-01');
var end = ee.Date('2021-04-01');
...
// 3) Agricultural Mask 
var agriculturalThreshold_top = 45
var agriculturalThreshold_low = 9
...
// 3.B Water mask
var start_water = ee.Date('2019-01-01')
var end_water = ee.Date('2021-12-01');
var water_mask = ImageCollectionS2(start_water, end_water).select('ndvi').median().lt(1).selfMask().rename('water');
...
var irrigationThreshold_top = 29
var irrigationThreshold_low = 19
